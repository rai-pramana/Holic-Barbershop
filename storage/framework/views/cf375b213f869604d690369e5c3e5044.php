<?php $__env->startSection('title', 'Edit Barber'); ?>
<?php $__env->startSection('page-title', 'Edit Barber'); ?>
<?php $__env->startSection('page-subtitle', $barber->name); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-xl">
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        <form method="POST" action="<?php echo e(route('admin.barbers.update', $barber)); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid sm:grid-cols-2 gap-4 mb-4">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="name" value="<?php echo e(old('name', $barber->name)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="<?php echo e(old('phone', $barber->phone)); ?>"
                ...
                <div>
                    ...
                    <select name="branch_id" required
                            class="w-full border <?php $__errorArgs = ['branch_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php else: ?> border-gray-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-400">
                        <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($branch->id); ?>" <?php echo e(old('branch_id', $barber->branch_id) == $branch->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="specialty" value="<?php echo e(old('specialty', $barber->specialty)); ?>"
                           class="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-400">
                </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="bio" rows="3"
                              class="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-400 resize-none"><?php echo e(old('bio', $barber->bio)); ?></textarea>
                </div>

                <div class="sm:col-span-2">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="is_available" value="1" <?php echo e(old('is_available', $barber->is_available) ? 'checked' : ''); ?>
            ...
            <div class="flex gap-3 pt-4 border-t border-gray-100">
                <a href="<?php echo e(route('admin.barbers.index')); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\raipr\Documents\Code\holic-barbershop\resources\views\admin\barbers\edit.blade.php ENDPATH**/ ?>