<?php $__env->startSection('title', 'Tambah Barber'); ?>
<?php $__env->startSection('page-title', 'Tambah Barber Baru'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-xl">
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        <form method="POST" action="<?php echo e(route('admin.barbers.store')); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="specialty" value="<?php echo e(old('specialty')); ?>"
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="bio" rows="3"
                              class="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-pink-400 focus:ring-1 focus:ring-pink-400 resize-none"><?php echo e(old('bio')); ?></textarea>
                </div>

                <div class="sm:col-span-2">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="is_available" value="1" <?php echo e(old('is_available', '1') ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\raipr\Documents\Code\holic-barbershop\resources\views\admin\barbers\create.blade.php ENDPATH**/ ?>