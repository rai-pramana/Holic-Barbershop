...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Barber'); ?> - HOLIC Barbershop</title>
...
<nav class="bg-gray-900 border-b border-gray-800 px-6 py-4 flex justify-between items-center">
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-gray-400 text-xs">Barber Panel — <?php echo e(auth()->user()->name); ?></p>
        </div>
    </div>

    <div class="flex items-center gap-4">
        <a href="<?php echo e(route('barber.dashboard')); ?>" class="text-sm text-gray-400 hover:text-white transition-colors">Dashboard</a>
...
<?php /**PATH C:\Users\raipr\Documents\Code\holic-barbershop\resources\views\layouts\barber.blade.php ENDPATH**/ ?>