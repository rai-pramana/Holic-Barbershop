...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'HOLIC Barbershop'); ?> — HOLIC Barbershop</title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'Sistem Antrean Online HOLIC Barbershop — Potong rambut tanpa ribet, antri dari mana saja.'); ?>">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center gap-2">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-sm font-medium text-gray-600 hover:text-pink-600 transition-colors px-3 py-2">Masuk</a>
                    <a href="<?php echo e(route('register')); ?>" class="text-sm font-semibold bg-gradient-to-r from-pink-500 to-purple-600 text-white px-4 py-2 rounded-xl hover:opacity-90 transition-opacity shadow-sm shadow-pink-500/20">
                        Daftar
                    </a>
                <?php endif; ?>
        ...
        <div id="mobile-nav" class="md:hidden border-t border-gray-100 py-3 space-y-1">
            <?php if(auth()->user()->isCustomer()): ?>
                <a href="<?php echo e(route('customer.dashboard')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-pink-600 transition-colors" onclick="toggleMobileNav()">
            ...
            <div class="px-3 py-2 flex items-center gap-2 text-sm text-gray-500">
                ...
                Halo, <strong class="text-gray-800"><?php echo e(auth()->user()->name); ?></strong>
            </div>
        </div>
        <?php endif; ?>
    </div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 space-y-2">
    ...
    <?php if(session('warning')): ?>
        <div class="flex items-start gap-3 bg-yellow-50 border border-yellow-200 text-yellow-800 rounded-2xl px-4 py-3" id="flash-warning">
            ...
            <span class="text-sm font-medium"><?php echo e(session('warning')); ?></span>
        </div>
    <?php endif; ?>
</div>
<?php endif; ?>
...
<main class="<?php echo $__env->yieldContent('main-class', 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8'); ?> flex-1" id="live-content">
...
<footer class="bg-white border-t border-gray-100 mt-auto">
    <div class="max-w-7xl mx-auto px-4 py-5 flex flex-col sm:flex-row justify-between items-center gap-2">
        ...
        <p class="text-xs text-gray-400">© <?php echo e(date('Y')); ?> · Sistem Antrean Online v1.0</p>
    </div>
</footer>
...
<?php /**PATH C:\Users\raipr\Documents\Code\holic-barbershop\resources\views\layouts\app.blade.php ENDPATH**/ ?>