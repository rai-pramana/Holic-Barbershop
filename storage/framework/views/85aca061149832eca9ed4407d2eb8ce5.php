...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="text-center text-gray-400 text-sm mt-6">
                Belum punya akun?
                <a href="<?php echo e(route('register')); ?>" class="text-pink-400 hover:text-pink-300 font-semibold">Daftar sekarang</a>
            </p>
...
<?php /**PATH C:\Users\raipr\Documents\Code\holic-barbershop\resources\views\auth\login.blade.php ENDPATH**/ ?>