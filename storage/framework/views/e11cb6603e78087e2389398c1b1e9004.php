            ...
            <form method="POST" action="<?php echo e(route('register')); ?>">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" required autofocus
                           class="w-full bg-gray-800/60 border <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-white/10 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500 transition-colors"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" required
                           class="w-full bg-gray-800/60 border <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-white/10 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="phone" name="phone" value="<?php echo e(old('phone')); ?>"
                           class="w-full bg-gray-800/60 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500 transition-colors"
                ...
                <div class="mb-4">
                    ...
                    <input type="password" id="password" name="password" required
                           class="w-full bg-gray-800/60 border <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-white/10 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="text-center text-gray-400 text-sm mt-6">
                Sudah punya akun?
                <a href="<?php echo e(route('login')); ?>" class="text-pink-400 hover:text-pink-300 font-semibold">Masuk di sini</a>
            </p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\raipr\Documents\Code\holic-barbershop\resources\views\auth\register.blade.php ENDPATH**/ ?>