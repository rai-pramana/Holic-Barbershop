...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — HOLIC Barbershop</title>
...
<aside id="sidebar" class="w-64 min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 flex flex-col flex-shrink-0 shadow-2xl">
    ...
    <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        ...
        <a href="<?php echo e(route('admin.queues.manage')); ?>"
           class="sidebar-link <?php echo e(request()->routeIs('admin.queues.manage') ? 'active' : ''); ?>">
            <span class="icon-wrap">
        ...
        <a href="<?php echo e(route('admin.checkin.index')); ?>"
           class="sidebar-link <?php echo e(request()->routeIs('admin.checkin.*') ? 'active' : ''); ?>">
            <span class="icon-wrap">
        ...
        <a href="<?php echo e(route('admin.queues.index')); ?>"
           class="sidebar-link <?php echo e(request()->routeIs('admin.queues.index') || request()->routeIs('admin.queues.show') ? 'active' : ''); ?>">
            <span class="icon-wrap">
        ...
        <a href="<?php echo e(route('admin.branches.index')); ?>"
           class="sidebar-link <?php echo e(request()->routeIs('admin.branches.*') ? 'active' : ''); ?>">
            <span class="icon-wrap">
        ...
        <a href="<?php echo e(route('admin.barbers.index')); ?>"
           class="sidebar-link <?php echo e(request()->routeIs('admin.barbers.*') ? 'active' : ''); ?>">
            <span class="icon-wrap">
...
<div class="flex-1 flex flex-col min-h-screen overflow-x-hidden">
    ...
    <header class="bg-white border-b border-gray-200 px-4 md:px-8 py-3 md:py-4 flex justify-between items-center sticky top-0 z-30">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-base md:text-xl font-bold text-gray-900 leading-tight"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h1>
                <?php if (! empty(trim($__env->yieldContent('page-subtitle')))): ?>
                <p class="text-xs md:text-sm text-gray-500 hidden sm:block"><?php echo $__env->yieldContent('page-subtitle'); ?></p>
                <?php endif; ?>
            </div>
        </div>
...
(function() {
    const NOTIF_URL = '<?php echo e(route("admin.notifications.poll")); ?>';
...
<?php /**PATH C:\Users\raipr\Documents\Code\holic-barbershop\resources\views\layouts\admin.blade.php ENDPATH**/ ?>