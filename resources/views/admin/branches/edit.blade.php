            ...
            <div class="grid sm:grid-cols-2 gap-4 mb-4">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="address" rows="2" required
                              class="w-full border @error('address') border-red-400 @else border-gray-300 @enderror rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 resize-none">{{ old('address', $branch->address) }}</textarea>
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="description" rows="3"
                              class="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 resize-none">{{ old('description', $branch->description) }}</textarea>
                </div>
