                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-1.5">
                            <a href="{{ route('admin.branches.show', $branch) }}"
                               title="Lihat Detail"
                               class="inline-flex items-center gap-1 text-xs font-semibold bg-gray-200 text-gray-700 px-2.5 py-1.5 rounded-lg hover:bg-gray-200 active:scale-95 transition-all">
