            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" rows="2"
                              class="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-pink-400 resize-none">{{ old('description', $service->description) }}</textarea>
                </div>
