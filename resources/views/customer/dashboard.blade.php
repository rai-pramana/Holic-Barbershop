        ...
        <div class="grid sm:grid-cols-2 gap-4">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 md:p-6 card-hover">
                ...
                <div class="flex gap-2">
                    ...
                    @if($queue->isPending())
                    <a href="{{ route('customer.queue.status', $queue) }}"
                       class="flex-1 inline-flex items-center justify-center gap-2 bg-gradient-to-r from-gray-900 to-slate-800 text-white text-sm font-semibold py-2.5 rounded-xl hover:opacity-90 transition-opacity">
