...
<div class="max-w-2xl mx-auto">
    ...
    <div class="flex items-center gap-2 mb-6">
        ...
        <div class="flex items-center gap-2 {{ $loop->last ? '' : 'flex-1' }}">
            <div class="w-6 h-6 rounded-full bg-gradient-to-br from-pink-500 to-purple-600 flex items-center justify-center text-white text-xs font-bold flex-shrink-0">{{ $i+1 }}</div>
                ...
                <label for="service_{{ $service->id }}" class="cursor-pointer">
                    ...
                    <div class="border-2 border-gray-100 rounded-xl p-4 peer-checked:border-pink-400 peer-checked:bg-pink-50/60 hover:border-gray-200 transition-all h-full">
                        <div class="flex justify-between items-start gap-2 mb-1.5">
                            ...
                            <span class="text-pink-600 font-bold text-sm whitespace-nowrap flex-shrink-0">{{ $service->formatted_price }}</span>
                        </div>
