                                ...
                                <div class="flex flex-wrap items-center gap-x-3 gap-y-1 mt-1">
                                    @if($fastestBarber)
                                        ...
                                        <span class="inline-flex items-center gap-1 text-xs text-gray-500">
                                            ...
                                            {{ (int) round($fastestBarber->estimated_wait_minutes) > 0 ? '~'.(int) round($fastestBarber->estimated_wait_minutes).' menit' : 'Langsung dilayani' }}
                                        </span>
                                    @else
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <div class="flex flex-wrap items-center gap-x-3 gap-y-1 mt-1">
                                    ...
                                    {{-- Estimated wait --}}
                                    @if((int) round($barber->estimated_wait_minutes) > 0)
                                    <span class="inline-flex items-center gap-1 text-xs text-gray-500">
                                        <svg class="w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                        ~{{ (int) round($barber->estimated_wait_minutes) }} menit
                                    </span>
                                    @else
                                    <span class="inline-flex items-center gap-1 text-xs text-gray-500">
                                        <svg class="w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
