    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-gray-900/80 backdrop-blur border border-white/10 rounded-3xl p-8 shadow-2xl">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" required autofocus
                           class="w-full bg-gray-800/60 border @error('name') border-red-500 @else border-white/10 @enderror rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500 transition-colors"
            ...
            <p class="text-center text-gray-400 text-sm mt-6">
                Sudah punya akun?
                <a href="{{ route('login') }}" class="text-pink-400 hover:text-pink-300 font-semibold">Masuk di sini</a>
            </p>
        </div>
    </div>
</body>
