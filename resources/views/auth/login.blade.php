    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-gray-900/80 backdrop-blur border border-white/10 rounded-3xl p-8 shadow-2xl">
            ...
            <form method="POST" action="{{ route('login') }}" id="login-form">
                ...
                <div class="flex items-center justify-between mb-6">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="remember" class="rounded border-white/10 bg-gray-800 text-amber-600 focus:ring-amber-500">
            ...
            <p class="text-center text-gray-400 text-sm mt-6">
                Belum punya akun?
                <a href="{{ route('register') }}" class="text-amber-500 hover:text-amber-400 font-semibold">Daftar sekarang</a>
            </p>
